...
Validiert, dass das dekorierte Feld eine hexadezimale Zahl ist. Nur die Zeichen `0-9` und `a-f` (Groß-/Kleinschreibung egal) sind erlaubt. Die Präfixe `0x` und `0h` sind ebenfalls erlaubt.
