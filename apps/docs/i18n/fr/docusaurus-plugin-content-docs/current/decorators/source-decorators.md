...
Les fichiers envoyés en `multipart/form-data` disposent de leurs propres décorateurs, `@UploadedFile()` et `@UploadedFiles()`, documentés dans [Décorateurs de téléversement de fichiers](./file-upload.md).
