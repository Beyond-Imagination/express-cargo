...
Файлы, отправленные как `multipart/form-data`, имеют собственные декораторы `@UploadedFile()` и `@UploadedFiles()`, описанные в [Декораторы загрузки файлов](./file-upload.md).
